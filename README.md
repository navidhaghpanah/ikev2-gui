...
- اتصال هوشمند (Smart Connect): رتبه‌بندی بهترین پروتکل از موجودی همین VPS و شرایط کلاینت که وارد می‌کنید — نه پروب ISP؛ توضیح اختیاری با Gateway سازگار با OpenAI (AIaaS ابر آروان)
