...
- **AI** — اتصال هوشمند (Smart Connect) با Gateway سازگار با OpenAI؛ رتبه بدون کلید هم کار می‌کند، مدل می‌تواند ترتیب را عوض کند. آدرس Gateway باید HTTPS عمومی باشد (localhost / نشانی خصوصی رد می‌شود)
